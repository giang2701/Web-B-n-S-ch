...
const ProductsUi = () => {
    ...
    return (
        <>
            ...
            <div className="xl:w-[1190px] xl:ml-[155px] xl:rounded-md h-[520px] bg-green-500 xl:mt-7 bg-[url(https://cdn0.fahasa.com/media/wysiwyg/Thang-01-2025/Web_BlockTet2025_v2.png)] bg-cover">
