                    ...
                    >
                        <div className="w-[100%] h-[100%] rounded-md bg-white">
                            ...
                            <div className="">
                                ...
                                {/* images small */}
                                <div className="flex ml-7 w-[450px] overflow-x-auto no-scrollbar scroll-smooth">
                                    {images.map((item) => (
                                        <div
                                            key={item.id}
                                        ...
                                        >
                                            {" "}
                                            {/* Wrapper cố định chiều rộng */}
                                            <Zoom>
                                                <img
                                                    src={item.img}
                                                    alt=""
                                                    className="w-[82px] h-[82px] rounded-md object-contain cursor-pointer hover:border-[1px] hover:border-blue-500"
                                                />
                                            </Zoom>
                                        </div>
                                    ))}
